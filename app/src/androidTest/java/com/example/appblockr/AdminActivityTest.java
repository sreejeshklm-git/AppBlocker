...
public class AdminActivityTest extends AppCompatActivity {
...
//            recyclerView.setAdapter(userAdapter);
        ...
        recyclerView.addItemDecoration(new DividerItemDecoration(AdminActivityTest.this,
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                AdminAdapter adapter = new AdminAdapter(AdminActivityTest.this,usersList,emailList);
